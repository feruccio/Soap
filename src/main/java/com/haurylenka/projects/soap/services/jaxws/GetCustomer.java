...
@XmlRootElement(name = "getCustomer", namespace = "http://services.soap.projects.haurylenka.com/")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "getCustomer", namespace = "http://services.soap.projects.haurylenka.com/", propOrder = {
    "code",
    "id"
})
